...
:: Android packaging
set AND_CERT_NAME="Application"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Application.p12
...
set IOS_PROVISION=cert\Application.mobileprovision
...
set APP_ID=air.Application

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Application
